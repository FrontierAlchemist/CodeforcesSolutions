...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/266/A problem.
/// </summary>
internal class Program
{
	...
	{
		int stonesCount = int.Parse(input.ReadLine());
		string stonesOrder = input.ReadLine();
		int stonesToRemove = 0;
		for (int i = 0; i < stonesCount - 1; ++i) {
			if (stonesOrder[i] == stonesOrder[i + 1]) {
				++stonesToRemove;
			}
		}
		output.WriteLine(stonesToRemove);
	}
