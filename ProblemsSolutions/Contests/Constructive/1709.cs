...
/// <summary>
/// Solve https://codeforces.com/contest/2121/problem/D problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		for (int i = arraySize - 1; i >= 0; --i) {
			if (a[i] > b[i]) {
				(a[i], b[i]) = (b[i], a[i]);
				operationsLog.Add($"3 {i + 1}");
			}
		}

		Output.WriteLine(operationsLog.Count);
