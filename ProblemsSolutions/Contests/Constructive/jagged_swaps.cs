...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1896/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int[] permutation = Input.ReadIntArray(permutationSize);
		bool isSortable = permutation[0] == 1;
		Output.WriteLine(isSortable ? "YES" : "NO");
	}
}
