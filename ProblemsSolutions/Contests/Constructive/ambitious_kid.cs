...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1866/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int minElementByModule = Math.Abs(Input.ReadInt());
		for (int i = 1; i < arraySize; ++i) {
			minElementByModule = Math.Min(minElementByModule, Math.Abs(Input.ReadInt()));
		}
		Output.WriteLine(minElementByModule);
	}
}
