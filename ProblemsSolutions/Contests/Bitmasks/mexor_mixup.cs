...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1567/B problem.
/// </summary>
internal class Solver
{
	...
	{
		int arrayMex = Input.ReadInt();
		int targetXor = Input.ReadInt();
		...
		int arraySize = arrayMex;
		if (arrayXor != targetXor) {
			++arraySize;
			int additionalNumber = arrayXor ^ targetXor;
			if (additionalNumber == arrayMex) {
				++arraySize;
			}
		}

		Output.WriteLine(arraySize);
	}
}
