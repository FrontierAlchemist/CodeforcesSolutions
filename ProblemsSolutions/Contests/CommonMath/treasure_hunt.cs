...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/2090/A problem.
/// </summary>
internal class Solver
{
	...
	{
		long firstDiggerSpeed = Input.ReadLong() * 10L;
		long secondDiggerSpeed = Input.ReadLong() * 10L;
		long depth = Input.ReadLong() * 10L + 5L;

		long commonSpeed = firstDiggerSpeed + secondDiggerSpeed;
		long remainDepth = depth % commonSpeed;

		bool isFirstDigger = remainDepth != 0L && remainDepth <= firstDiggerSpeed;
		Output.WriteLine(!isFirstDigger ? "YES" : "NO");
	}
}
