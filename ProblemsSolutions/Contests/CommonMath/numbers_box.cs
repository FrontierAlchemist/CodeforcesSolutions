...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1447/B problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		long totalAbsoluteSum = 0L;
		int minimalByAbsoluteNumber = int.MaxValue;
		for (int i = 0; i < rowsCount; ++i) {
			for (int j = 0; j < columnsCount; ++j) {
				...
				totalAbsoluteSum += Math.Abs(currentNumber);
				minimalByAbsoluteNumber = Math.Min(minimalByAbsoluteNumber, Math.Abs(currentNumber));
			}
		}

		if (negativeNumbersCount % 2 == 1 && !isZeroExist) {
			totalAbsoluteSum -= 2 * minimalByAbsoluteNumber;
		}
		Output.WriteLine(totalAbsoluteSum);
	}
}
