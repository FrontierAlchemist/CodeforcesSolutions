...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1794/C problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int[] sequence = Input.ReadIntArray(sequenceLength);
		int firstIndexOfBestSubsequence = 0;
		int bestSubsequenceLength = 0;
		for (int i = 0; i < sequenceLength; ++i) {
			if (sequence[firstIndexOfBestSubsequence] >= bestSubsequenceLength + 1) {
				++bestSubsequenceLength;
			} else {
				++firstIndexOfBestSubsequence;
			}
			Output.Write($"{bestSubsequenceLength} ");
		}
		Output.WriteLine();
	}
}
