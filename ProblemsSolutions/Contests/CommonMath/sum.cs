...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1742/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int b = Input.ReadInt();
		int c = Input.ReadInt();
		bool isOneEqualToSumOfOthers = (a == b + c) || (b == a + c) || (c == a + b);
		Output.WriteLine(isOneEqualToSumOfOthers ? "YES" : "NO");
	}
}
