...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1731/B problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		const long InvSix = 166666668L;

		long fieldSize = Input.ReadLong();
		long answer = Multiply(
			Multiply(
				Multiply(fieldSize, fieldSize + 1L), Multiply(4L, fieldSize) + Modulo - 1L
			),
			InvSix
		);
		answer = Multiply(answer, 2022L);
		Output.WriteLine(answer);

		static long Multiply(long a, long b) => a * b % Modulo;
	}
}
