...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1459/B problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int distinctEndPointes;
		if (stepsCount % 2 == 0) {
			int a = stepsCount / 2 + 1;
			distinctEndPointes = a * a;
		} else {
			int b = (stepsCount + 1) / 2;
			int c = b * (b + 1) / 2;
			distinctEndPointes = 4 * c;
		}

		Output.WriteLine(distinctEndPointes);
	}
}
