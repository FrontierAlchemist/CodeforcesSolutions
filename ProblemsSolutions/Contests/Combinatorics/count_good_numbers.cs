...
/// <summary>
/// Solve https://codeforces.com/contest/2125/problem/C problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		long goodIntegersCount = (r - l + 1) - (CalculateNumberOfBadIntegers(r) - CalculateNumberOfBadIntegers(l - 1));

		Output.WriteLine(goodIntegersCount);

		long CalculateNumberOfBadIntegers(long lastNumber)
		{
			long dividedByTwo = lastNumber / 2;
			long dividedByThree = lastNumber / 3 - lastNumber / 6;
			long dividedByFive = lastNumber / 5 - lastNumber / 10 - lastNumber / 15 + lastNumber / 30;
			long dividedBySeven =
				lastNumber / 7 - lastNumber / 14 - lastNumber / 21 - lastNumber / 35 +
				lastNumber / 42 + lastNumber / 70 + lastNumber / 105 - lastNumber / 210;
