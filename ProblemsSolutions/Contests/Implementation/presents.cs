...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/136/A problem.
/// </summary>
internal class Program
{
	...
	{
		int friendsCount = int.Parse(input.ReadLine());
		int[] presenters = new int[friendsCount];
		string[] valuesFromInput = input.ReadLine().Split();
		for (int i = 0; i < friendsCount; ++i) {
			int reciver = int.Parse(valuesFromInput[i]);
			presenters[reciver - 1] = i + 1;
		}
		output.WriteLine(string.Join(' ',  presenters));
	}
