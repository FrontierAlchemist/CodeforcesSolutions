...
/// <summary>
/// Solve https://codeforces.com/contest/2065/problem/A problem.
/// </summary>
internal class Program
{
	...
	{
		string wordInSingularForm = input.ReadLine();
		string wordInPluralForm = wordInSingularForm[0..^2] + "i";
		output.WriteLine(wordInPluralForm);
	}
