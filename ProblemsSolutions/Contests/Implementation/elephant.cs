...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/617/A problem.
/// </summary>
internal class Program
{
	...
	{
		int targetPosition = int.Parse(input.ReadLine());
		int stepsToTargetPosition = Math.DivRem(targetPosition, 5, out int remainder);
		if (remainder > 0) {
			++stepsToTargetPosition;
		}
		output.WriteLine(stepsToTargetPosition);
	}
