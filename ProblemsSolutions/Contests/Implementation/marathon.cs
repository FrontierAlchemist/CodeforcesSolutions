...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1692/A problem.
/// </summary>
internal class Solver
{
	...
	{
		const int ParticipantsNumber = 4;

		int timurDistance = Input.ReadInt();
		int participantsInFrontOfTimur = 0;
		for (int i = 1; i < ParticipantsNumber; ++i) {
			int otherParticipantDistance = Input.ReadInt();
			if (otherParticipantDistance > timurDistance) {
				++participantsInFrontOfTimur;
			}
		}
		Output.WriteLine(participantsInFrontOfTimur);
	}
}
