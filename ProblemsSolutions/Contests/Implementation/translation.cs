...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/41/A problem.
/// </summary>
internal class Program
{
	...
	private static void SolveProblem()
	{
		...
		string translatedString = input.ReadLine();

		if (sourceString.Length != translatedString.Length) {
			output.WriteLine("NO");
			return;
		}
		...
		for (int i = 0; i < stringLength; ++i) {
			if (sourceString[i] != translatedString[stringLength - 1 - i]) {
				isTranslatedCorrectly = false;
				break;
			}
		}
		output.WriteLine(isTranslatedCorrectly ? "YES" : "NO");
	}
