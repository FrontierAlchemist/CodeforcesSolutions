...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/2109/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int prevoiusResult = Input.ReadInt();
		int wonsCount = prevoiusResult;

		for (int i = 1; i < playersCount; ++i) {
			int currentResult = Input.ReadInt();
			hasLairs |= prevoiusResult == 0 && currentResult == 0;
			wonsCount += currentResult;
			prevoiusResult = currentResult;
		}
		hasLairs |= wonsCount == playersCount;

		Output.WriteLine(hasLairs ? "YES" : "NO");
	}
}
