...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/2111/A problem.
/// </summary>
internal class Solver
{
	...
	{
		int targetChargeLevel = Input.ReadInt();
		int minimalOperationsCount = 0;
		while (targetChargeLevel > 0) {
			targetChargeLevel /= 2;
			++minimalOperationsCount;
		}
		minimalOperationsCount = minimalOperationsCount * 2 + 1;
