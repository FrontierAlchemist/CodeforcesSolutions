...
internal class Solver
{
	...
	/// <summary>
	/// Solve https://codeforces.com/problemset/problem/139/A problem.
	/// </summary>
	public static void SolveProblem()
	{
		int pagesCount = Input.GetInt();
		int[] pagesCountPerDay = Input.GetIntArray(7);
		int currentDay = 0;
		while (pagesCount > 0) {
			currentDay = currentDay == 7 ? 1 : currentDay + 1;
			pagesCount -= pagesCountPerDay[currentDay - 1];
		}
		Output.WriteLine(currentDay);
	}
}
