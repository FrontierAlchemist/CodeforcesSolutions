...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/268/B problem.
/// </summary>
internal class Program
{
	...
	{
		int buttons = input.GetInt();
		int markedButtons = 0;
		int pushes = 0;
		for (int unmarkedButtons = buttons; unmarkedButtons > 0; --unmarkedButtons) {
			pushes += (unmarkedButtons - 1) * (markedButtons++ + 1) + 1;
		}
		output.WriteLine(pushes);
	}
