...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1761/A problem.
/// </summary>
internal class Solver
{
	...
	{
		int permutationSize = Input.ReadInt();
		int longestCommonPrefixSize = Input.ReadInt();
		int longestCommonSuffixSize = Input.ReadInt();
		bool isValidPermutationsPairExist =
			(longestCommonPrefixSize == permutationSize && longestCommonSuffixSize == permutationSize) ||
			(longestCommonPrefixSize + longestCommonSuffixSize + 2 <= permutationSize);
		Output.WriteLine(isValidPermutationsPairExist ? "YES" : "NO");
	}
}
