...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1409/A problem.
/// </summary>
internal class Program
{
	...
	private static void SolveProblem()
	{
		...
		int a = int.Parse(valuesFromInput[0]);
		int b = int.Parse(valuesFromInput[1]);
		int movesCount = Math.DivRem(Math.Abs(a - b), 10, out int remainder);
		if (remainder > 0) {
			++movesCount;
		}
		output.WriteLine(movesCount);
	}
