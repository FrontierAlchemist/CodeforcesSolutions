...
internal class Solver
{
	...
	/// <summary>
	/// Solve https://codeforces.com/problemset/problem/1141/A problem.
	/// </summary>
	public static void SolveProblem()
	{
		int baseNumber = Input.GetInt();
		int targetNumber = Input.GetInt();
		bool isTransformationExsit = false;
		int operationsCount = 0;

		int multiplier = Math.DivRem(targetNumber, baseNumber, out int remainder);
		if (remainder == 0) {
			...
			isTransformationExsit = multiplier == 1;
		}

		Output.WriteLine(isTransformationExsit ? operationsCount : -1);
	}
}
