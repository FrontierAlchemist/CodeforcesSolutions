...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1373/A problem.
/// </summary>
internal class Solver
{
	...
	{
		int firstShopPerDonutCost = Input.ReadInt();
		int secondShopBoxSize = Input.ReadInt();
		int secondShopPerBoxCost = Input.ReadInt();

		int profitableDonutsCountBoughtInFirstShop = firstShopPerDonutCost < secondShopPerBoxCost ? 1 : -1;
		Output.Write($"{profitableDonutsCountBoughtInFirstShop} ");

		int profitableDonutsCountBoughtInSecondShop = -1;
		if (firstShopPerDonutCost > secondShopPerBoxCost) {
			profitableDonutsCountBoughtInSecondShop = secondShopBoxSize;
		} else {
			profitableDonutsCountBoughtInSecondShop = (secondShopPerBoxCost / firstShopPerDonutCost) + 1;
			if (profitableDonutsCountBoughtInSecondShop > secondShopBoxSize) {
				profitableDonutsCountBoughtInSecondShop = -1;
			}
		}
		Output.WriteLine($"{profitableDonutsCountBoughtInSecondShop} ");
	}
}
