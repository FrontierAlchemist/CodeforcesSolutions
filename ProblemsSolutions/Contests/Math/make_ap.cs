...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1624/B problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		bool isMultiplierExist = FirstCheck() || SecondCheck() || ThirdCheck();

		Output.WriteLine(isMultiplierExist ? "YES" : "NO");

		bool FirstCheck()
		{
			int multiplier = Math.DivRem(2 * b - a, c, out int remadiner);
			return remadiner == 0 && multiplier > 0;
		}

		bool SecondCheck()
		{
			int multiplier = Math.DivRem(2 * b - c, a, out int remainder);
			return remainder == 0 && multiplier > 0;
		}

		bool ThirdCheck()
		{
			int multiplier = Math.DivRem(a + c, b, out int remadiner);
			return remadiner == 0 && multiplier > 0 && multiplier % 2 == 0;
		}
	}
}
