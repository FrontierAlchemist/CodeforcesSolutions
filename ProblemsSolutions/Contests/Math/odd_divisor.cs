...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1475/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		while ((number & 1) == 0L && number > 1L) {
			number >>= 1;
		}
		bool isAnswerExist = number > 1L;
		Output.WriteLine(isAnswerExist ? "YES" : "NO");
	}
}
