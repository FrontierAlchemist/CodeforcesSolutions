...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1788/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		if (twosCount == 0) {
			separatorIndex = 1;
		} else if (twosCount % 2 == 0) {
			int twosCountInSeparatedPart = twosCount / 2;
			for (int i = 0; i < sequenceLength; ++i) {
				if (sequence[i] == 2) {
					--twosCountInSeparatedPart;
				}
				if (twosCountInSeparatedPart == 0) {
					separatorIndex = i + 1;
					break;
				}
			}
		}
		Output.WriteLine(separatorIndex);
	}
}
