...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/486/A problem.
/// </summary>
internal class Program
{
	...
	{
		long argument = long.Parse(input.ReadLine());
		long functionValue = argument % 2 == 0 ? argument / 2 : -(argument + 1) / 2;
		output.WriteLine(functionValue);
	}
