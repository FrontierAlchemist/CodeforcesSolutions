...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1593/B problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int minimalOperationsCount = number.Length;
		for (int i = number.Length - 1; i >= 0; --i) {
			if (number[i] == '0') {
				for (int j = i - 1; j >= 0; --j) {
					if (number[j] == '0' || number[j] == '5') {
						int operationsCount = (number.Length - i - 1) + (i - j - 1);
