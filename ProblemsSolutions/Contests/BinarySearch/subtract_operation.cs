...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1656/B problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		bool isTargetNumberExist = false;
		for (int i = 0; i < arraySize; ++i) {
			if (IsNumberExist(array[i] + targetNumber) || IsNumberExist(array[i] - targetNumber)) {
				isTargetNumberExist = true;
				break;
			}
		}

		Output.WriteLine(isTargetNumberExist ? "YES" : "NO");

		bool IsNumberExist(int target)
		{
			int leftPointer = 0;
