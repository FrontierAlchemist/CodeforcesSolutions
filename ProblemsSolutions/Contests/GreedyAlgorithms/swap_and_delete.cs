...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1913/B problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int totalZeroesCount = binaryString.Length - totalOnesCount;
		for (int i = 0; i < binaryString.Length; ++i) {
			if (binaryString[i] == '1') {
				if (totalZeroesCount > 0) {
					--totalZeroesCount;
					++differentPairsCount;
				} else {
					break;
		...
		int minimalTransformationCost = binaryString.Length - differentPairsCount;
		Output.WriteLine(minimalTransformationCost);
	}
}
