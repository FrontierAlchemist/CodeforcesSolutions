...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1878/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		bool isTargetElementExist = false;
		for (int i = 0; i < arraySize; ++i) {
			if (array[i] == targetNumber) {
				isTargetElementExist = true;
				break;
			}
		}
		Output.WriteLine(isTargetElementExist ? "YES" : "NO");
	}
}
