...
/// <summary>
/// Solve https://codeforces.com/contest/2074/problem/B problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int arraySize = sequenceLength + sequenceLength - 1;
		var array = new int[arraySize];
		for (int i = 0; i < sequenceLength; ++i) {
			array[i] = Input.ReadInt();
		}
		for (int i = sequenceLength; i < arraySize; ++i) {
			array[i] = int.MaxValue;
		}
		Array.Sort(array);
		for (int i = 0; i < sequenceLength - 1; ++i) {
			array[sequenceLength + i] = array[i * 2] + array[i * 2 + 1] - 1;
		}
		Output.WriteLine(array[arraySize - 1]);
	}
}
