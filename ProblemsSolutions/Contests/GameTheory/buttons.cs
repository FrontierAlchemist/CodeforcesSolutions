...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1858/A problem.
/// </summary>
internal class Solver
{
	...
	{
		int firstPlayerButtons = Input.ReadInt();
		int secondPlayerButtons = Input.ReadInt();
		int bothPlayersButtons = Input.ReadInt();

		firstPlayerButtons += bothPlayersButtons % 2;
		string verdict = firstPlayerButtons > secondPlayerButtons ? "First" : "Second";
