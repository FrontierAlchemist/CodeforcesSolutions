...
/// <summary>
/// Solve https://codeforces.com/contest/2123/problem/D problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int segmentLength = Input.ReadInt();
		...
		bool isAliceWin = totalOnesCount <= segmentLength || stringLength < 2 * segmentLength;

		Output.WriteLine(isAliceWin ? "Alice" : "Bob");
	}
}
