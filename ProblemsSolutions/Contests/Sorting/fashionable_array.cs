...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/2110/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int rmn = array[0] % 2;
		int rmx = array[^1] % 2;
		int minRemovingOperations = arraySize - 1;
		for (int i = 0; i < arraySize - 1; ++i) {
			if ((array[i] % 2 == rmx) || (array[^(i + 1)] % 2 == rmn)) {
				minRemovingOperations = i;
				break;
			}
		}

		Output.WriteLine(minRemovingOperations);
	}
}
