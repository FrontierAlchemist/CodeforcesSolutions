...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1997/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		if (insertIndex == -1) {
			Output.Write(password[0] == 'a' ? 'z' : 'a');
			Output.WriteLine(password);
		} else {
			Output.Write(password[..insertIndex]);
			Output.Write(password[insertIndex] == 'a' ? 'z' : 'a');
			Output.WriteLine(password[insertIndex..]);
		}
	}
}
