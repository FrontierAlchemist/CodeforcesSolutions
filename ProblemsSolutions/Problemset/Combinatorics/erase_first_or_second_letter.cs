...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1917/B problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		long distinctSuffixesCount = 0L;
		HashSet<char> distinctChars = new();
		for (int i = 0; i < sourceStringLength; ++i) {
			distinctChars.Add(sourceString[i]);
			distinctSuffixesCount += distinctChars.Count;
		}

		Output.WriteLine(distinctSuffixesCount);
	}
}
