...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1869/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		_ = Input.ReadIntArray(arraySize);

		if (arraySize % 2 == 0) {
			Output.WriteLine("2");
			Output.WriteLine($"1 {arraySize}");
			Output.WriteLine($"1 {arraySize}");
		} else {
			Output.WriteLine("4");
			Output.WriteLine($"1 2");
			Output.WriteLine($"1 2");
			Output.WriteLine($"2 {arraySize}");
			Output.WriteLine($"2 {arraySize}");
		}
	}
}
