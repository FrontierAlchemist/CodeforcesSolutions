...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/579/A problem.
/// </summary>
internal class Program
{
	...
	{
		int bacteriesTargetNumber = int.Parse(input.ReadLine());
		int generationsCount = 0;
		while (bacteriesTargetNumber > 0) {
			bool isCurrentNumberEven = (bacteriesTargetNumber & 1) == 0;
			if (!isCurrentNumberEven) {
				++generationsCount;
			}
			bacteriesTargetNumber >>= 1;
		}
		output.WriteLine(generationsCount);
	}
