...
/// <summary>
/// Solve https://codeforces.com/contest/2114/problem/B problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int goodPairsRequested = Input.ReadInt();
		...
		int zeroesCount = stringLength - onesCount;
		int badPairsRequested = stringLength / 2 - goodPairsRequested;
		zeroesCount -= badPairsRequested;
		onesCount -= badPairsRequested;

		if (zeroesCount < 0 || onesCount < 0) {
			Output.WriteLine("NO");
		} else {
			int canCreateGoodPairs = zeroesCount / 2 + onesCount / 2;
			Output.WriteLine(canCreateGoodPairs >= goodPairsRequested ? "YES" : "NO");
		}
