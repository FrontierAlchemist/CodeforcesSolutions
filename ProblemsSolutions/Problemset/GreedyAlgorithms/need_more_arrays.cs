...
/// <summary>
/// Solve https://codeforces.com/contest/2114/problem/C problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int maximalCreatedArraysCount = 1;
		int indexOfLastTakenElement = 0;
		for (int i = 1; i < arraySize; ++i) {
			if (array[i] > array[indexOfLastTakenElement] + 1) {
				++maximalCreatedArraysCount;
				indexOfLastTakenElement = i;
			}
		}

		Output.WriteLine(maximalCreatedArraysCount);
	}
}
