...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1853/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		for (int i = 1; i < arraySize; ++i) {
			...
			minimalDifference = Math.Min(minimalDifference, array[i] - array[i - 1]);
		}
		int minimalOperationsCount = isArraySorted ? (minimalDifference + 2) / 2 : 0;
