...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1675/B problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int operationsToModifiedCount = 0;
		for (int i = arraySize - 2; i >= 0; --i) {
			if (array[i + 1] == 0) {
				operationsToModifiedCount = -1;
				break;
			}
			while (array[i] >= array[i + 1]) {
				array[i] /= 2;
				++operationsToModifiedCount;
			}
		}
		Output.WriteLine(operationsToModifiedCount);
	}
}
