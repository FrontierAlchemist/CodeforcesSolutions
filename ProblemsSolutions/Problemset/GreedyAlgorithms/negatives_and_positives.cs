...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1791/E problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int minimalAbsoluteValue = int.MaxValue;
		long maximalSum = 0L;
		for (int i = 0; i < arraySize; ++i) {
			...
			minimalAbsoluteValue = Math.Min(minimalAbsoluteValue, number);
			maximalSum += number;
		}

		if (negativeNumbersCount % 2 == 1) {
			maximalSum -= 2 * minimalAbsoluteValue;
		}
		Output.WriteLine(maximalSum);
	}
}
