...
/// <summary>
/// Solve https://codeforces.com/contest/1873/problem/D problem.
/// </summary>
internal class Solver
{
	...
	{
		int stripLength = Input.ReadInt();
		int brushLength = Input.ReadInt();
		string strip = Input.ReadString();

		int operationsCount = 0;
		for (int i = 0; i < stripLength;) {
			if (strip[i] == 'B') {
				i += brushLength;
				++operationsCount;
			} else {
