...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/2048/A problem.
/// </summary>
internal class Solver
{
	...
	{
		string sourceExpression = Input.ReadString();

		char operatorChar;
		if (sourceExpression[0] < sourceExpression[2]) {
			operatorChar = '<';
		} else if (sourceExpression[0] == sourceExpression[2]) {
			operatorChar = '=';
		} else {
			operatorChar = '>';
		}

		string fixedExpression = $"{sourceExpression[0]}{operatorChar}{sourceExpression[2]}";
		Output.WriteLine(fixedExpression);
	}
}
