...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/500/A problem.
/// </summary>
internal class Program
{
	...
	{
		int cellsCount = input.GetInt();
		int targetCell = input.GetInt() - 1;
		int[] portalsValues = input.GetIntArray(cellsCount - 1);

		int currentCell = 0;
		while (currentCell < targetCell) {
			currentCell = portalsValues[currentCell] + currentCell;
		}
		output.WriteLine(currentCell == targetCell ? "YES" : "NO");
	}
