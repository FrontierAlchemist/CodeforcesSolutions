...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/733/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		for (int i = 0; i < sourceString.Length; ++i) {
			++currentJumpLength;
			if (IsVowel(sourceString[i])) {
				requiredJumpLength = Math.Max(requiredJumpLength, currentJumpLength);
				currentJumpLength = 0;
			}
		}
		requiredJumpLength = Math.Max(requiredJumpLength, ++currentJumpLength);
		Output.WriteLine(requiredJumpLength);
