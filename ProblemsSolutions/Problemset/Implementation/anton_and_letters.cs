...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/443/A problem.
/// </summary>
internal class Program
{
	...
	{
		string prunedSourceString = input.ReadLine()[1..^1];
		int distinctLettersCount = 0;
		if (prunedSourceString.Length > 0) {
			distinctLettersCount = new HashSet<string>(prunedSourceString.Split(", ")).Count;
		}
		output.WriteLine(distinctLettersCount);
	}
