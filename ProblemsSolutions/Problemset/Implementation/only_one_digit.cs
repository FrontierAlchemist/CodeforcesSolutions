...
/// <summary>
/// Solve https://codeforces.com/contest/2126/problem/A problem.
/// </summary>
internal class Solver
{
	...
	{
		string sourceNumber = Input.ReadString();
		char smallestDigit = sourceNumber[0];
		for (int i = 1; i < sourceNumber.Length; ++i) {
			if (sourceNumber[i] < smallestDigit) {
				smallestDigit = sourceNumber[i];
			}
		}
		Output.WriteLine(smallestDigit);
	}
}
