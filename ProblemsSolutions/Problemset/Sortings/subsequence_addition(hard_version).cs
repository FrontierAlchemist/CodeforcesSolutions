...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1807/G2 problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		bool isPossibleToRestoreSourceArray = array[0] == 1;
		if (isPossibleToRestoreSourceArray) {
			long sum = 1L;
			for (int i = 1; i < arraySize; ++i) {
				if (array[i] > sum) {
					isPossibleToRestoreSourceArray = false;
					break;
				}
				sum += array[i];
			}
		...
		Output.WriteLine(isPossibleToRestoreSourceArray ? "YES" : "NO");
	}
}
