...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1783/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		bool isArrayBeautiful = true;
		if (array[0] == array[1]) {
			bool isNotEqualElementFound = false;
			for (int i = 2; i < arraySize; ++i) {
				if (array[i] != array[i - 1]) {
					isNotEqualElementFound = true;
					(array[1], array[i]) = (array[i], array[1]);
					break;
				}
			}
			if (!isNotEqualElementFound) {
				isArrayBeautiful = false;
			}
		}
		if (isArrayBeautiful) {
