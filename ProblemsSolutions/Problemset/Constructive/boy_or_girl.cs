...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/236/A problem.
/// </summary>
internal class Program
{
	...
	private static void SolveProblem()
	{
		...
		HashSet<char> distinctCharacters = new(message);
		bool isUserGirl = distinctCharacters.Count % 2 == 0;
		string verdict = isUserGirl ? "CHAT WITH HER!" : "IGNORE HIM!";
