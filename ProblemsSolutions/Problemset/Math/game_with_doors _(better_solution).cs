...
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int commonRooms = Math.Min(
			Math.Min(aliceSegment.right, bobSegment.right) - Math.Max(aliceSegment.left, bobSegment.left) + 1,
			Math.Min(aliceSegment.right - aliceSegment.left + 1, bobSegment.right - bobSegment.left + 1)
		);
