...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1607/B problem.
/// </summary>
internal class Solver
{
	...
	{
		long startPoint = Input.ReadLong();
		long jumpsCount = Input.ReadLong();

		long distanceFromStartPoint = 0L;
		switch (jumpsCount % 4L) {
			case 1L:
				distanceFromStartPoint = -jumpsCount;
				break;
			case 2L:
				distanceFromStartPoint = 1L;
				break;
			case 3L:
				distanceFromStartPoint = jumpsCount + 1L;
				break;
		}
		if ((startPoint % 2L + 2L) % 2L == 1L) {
			distanceFromStartPoint = -distanceFromStartPoint;
		}

		long finishPoint = startPoint + distanceFromStartPoint;
		Output.WriteLine(finishPoint);
	}
}
