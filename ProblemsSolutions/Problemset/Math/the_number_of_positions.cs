...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/124/A problem.
/// </summary>
internal class Program
{
	...
	{
		int queueLength = input.GetInt();
		int peopleAhead = input.GetInt();
		int peopleBehind = input.GetInt();
		int maxPeopleBehind = Math.Min(peopleBehind, queueLength - 1 - peopleAhead);
		int possiblePositionsCount = maxPeopleBehind + 1;
		output.WriteLine(possiblePositionsCount);
	}
