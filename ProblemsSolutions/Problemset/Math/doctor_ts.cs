...
/// <summary>
/// Solve https://codeforces.com/contest/2106/problem/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		long totalOnes = (ones - 1) * ones + (length - ones) * (ones + 1);
		Output.WriteLine(totalOnes);
	}
}
