...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1335/A problem.
/// </summary>
internal class Program
{
	...
	{
		int candiesCount = int.Parse(input.ReadLine());
		int waysToDisributeCount = Math.DivRem(candiesCount, 2, out int remainder);
		if (remainder == 0) {
			--waysToDisributeCount;
		}
		output.WriteLine(waysToDisributeCount);
	}
