...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/334/A problem.
/// </summary>
internal class Solver
{
	...
	{
		int brothersCount = Input.ReadInt();
		int halfBrothersCount = brothersCount / 2;
		int smallestPackSize = 1;
		int biggestPaskSize = brothersCount * brothersCount;
		for (int i = 0; i < brothersCount; ++i) {
			for (int j = 0; j < halfBrothersCount; ++j) {
				Output.Write($"{smallestPackSize++} {biggestPaskSize--} ");
			}
			Output.WriteLine();
		}
	}
