...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1342/A problem.
/// </summary>
internal class Program
{
	...
	private static void SolveProblem()
	{
		int x = input.GetInt();
		int y = input.GetInt();
		long oneNumberModificationCost = input.GetInt();
		long bothNumbersModificationCost = input.GetInt();
		long minimalTotalCost = Math.Min(
			oneNumberModificationCost * Math.Abs(x - y) + bothNumbersModificationCost * Math.Min(x, y),
			oneNumberModificationCost * (x + y)
		);
