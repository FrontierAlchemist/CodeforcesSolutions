...
/// <summary>
/// Solve https://codeforces.com/contest/1915/problem/C problem.
/// </summary>
internal class Solver
{
	...
	{
		int bucketsCount = Input.ReadInt();
		double squaresCount = 0.0;
		for (int i = 0; i < bucketsCount; ++i) {
			squaresCount += Input.ReadInt();
		}

		double sqrt = Math.Sqrt(squaresCount);
		bool isPossibleToBuildBigSquare = sqrt == Math.Ceiling(sqrt);
		Output.WriteLine(isPossibleToBuildBigSquare ? "YES" : "NO");
	}
}
