...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/2072/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int targetSum = Math.Abs(Input.ReadInt());
		int border = Input.ReadInt();
		int operationsCount = Math.DivRem(targetSum, border, out int remainder);
		if (remainder != 0) {
			++operationsCount;
		}
		if (operationsCount > arraySize) {
			operationsCount = -1;
		}
