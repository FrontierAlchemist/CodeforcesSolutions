...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1814/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		long gcd = GetGcd(2, k);
		Output.WriteLine(n % gcd == 0 ? "YES" : "NO");
	}

	private static long GetGcd(long a, long b) => b > 0L ? GetGcd(b, a % b) : a;
}
