...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1487/B problem.
/// </summary>
internal class Solver
{
	...
	{
		int spotsCount = Input.ReadInt();
		int hours = Input.ReadInt();

		int extraSteps = 0;
		if (spotsCount % 2 == 1) {
			int period = spotsCount / 2;
			extraSteps = (hours - 1) / period;
		}

		int finalSpotNumber = (hours + extraSteps) % spotsCount;
		if (finalSpotNumber == 0) {
			finalSpotNumber = spotsCount;
		}

		Output.WriteLine(finalSpotNumber);
	}
}
