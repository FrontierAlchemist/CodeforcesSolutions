...
/// <summary>
/// Solve https://codeforces.com/problemset/problem/1485/A problem.
/// </summary>
internal class Solver
{
	...
	private static void Solve()
	{
		...
		int minimalOperationCount = int.MaxValue;
		for (int i = 0; i < 32; ++i) {
			int operationsCount = i;
			int modified_b = b + i;
			if (modified_b == 1) {
				continue;
			}
			...
			minimalOperationCount = Math.Min(minimalOperationCount, operationsCount);
		}

		Output.WriteLine(minimalOperationCount);
	}
}
